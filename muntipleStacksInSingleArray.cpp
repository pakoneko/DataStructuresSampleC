...
https://medium.com/@waliamrinal/implementing-multiple-stacks-in-a-single-array-5d9333608f26
 @author Mrinal Walia */
#include <stdio.h>
...
//max represents the upper bound for a stackint s[50],top[50],min[50],max[50];//ns is stack number
...
void init(void)
{
    ...
    void createstack()
    {
        ...
        //and it’s max will be at index one lesser than it’s sizemin[0]= -1;
        max[0] = size - 1;
        top[0] = -1;
    ...
    } //end function display//main functionint main() {
